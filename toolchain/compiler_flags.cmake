...
set(CXX_FLAGS "-std=gnu++11 -O0 -g -fno-rtti -fno-exceptions -fverbose-asm -MMD")
...
# -Wdouble-promotion - warring of all implicit casting
set(C_WARNINGS "-Wall -Wextra -Wstrict-prototypes -Wdouble-promotion")
...
#set(LD_FLAGS "-Wl,-Map=${PROJECT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.map,--cref -T${LINKER_SCRIPT} -g -Wl,--gc-sections")
set(LD_FLAGS "-Wl,-Map=${PROJECT_BINARY_DIR}/${CMAKE_PROJECT_NAME}.map --specs=nano.specs -T ${LINKER_SCRIPT}")
